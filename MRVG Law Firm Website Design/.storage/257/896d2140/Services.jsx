  ...
  return (
    <section id="atuacao" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 max-w-6xl mx-auto mb-16">
          <div className="text-center md:text-left md:w-1/2">
            ...
            <h2 className="text-4xl font-[Playfair_Display] font-bold text-gray-800 mt-2 mb-4">
              Especialistas em casos complexos
            </h2>
          ...
          <div className="w-full md:w-1/2 max-w-md mx-auto">
            <div className="transform transition-transform hover:scale-[1.02] duration-300">
              <LegalThemeImage className="w-full h-auto shadow-xl rounded-lg" />
            </div>
            <p className="text-sm text-gray-500 italic mt-3 text-center">"Justiça não é apenas o que está escrito na lei, mas o que se realiza na sua aplicação."</p>
          </div>
        </div>
