      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-5 text-xl text-gray-600">
            Conheça os sócios do escritório MRVG Advogados
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {partners.map((partner) => (
            <div key={partner.id} className="bg-white rounded-lg shadow-xl overflow-hidden transform transition-transform duration-300 hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-lg mb-2">{partner.position}</p>
                <p className="text-gray-600 text-sm italic mb-4">{partner.specialty}</p>
                
                <div className="space-y-2">
                  <div className="flex items-start">
                    <i className="fas fa-envelope text-gray-600 mr-3 mt-1"></i>
                    <p className="text-gray-700">{partner.email}</p>
                  </div>
                  <div className="flex items-start">
                    <i className="fas fa-globe text-gray-600 mr-3 mt-1"></i>
                    <p className="text-gray-700">{partner.website}</p>
                  </div>
                </div>
                
                <div className="mt-6 flex justify-center space-x-4">
                  <a href={`mailto:${partner.email}`} className="bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-700 transition-colors">
