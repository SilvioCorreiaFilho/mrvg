  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 z-10 text-center md:text-left">
        ...
        <div className="max-w-3xl" style={contentStyles}>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-[Playfair_Display] font-bold text-white mb-6 drop-shadow-lg">
            Tradição, excelência e resultados
          </h1>
          <p className="text-xl md:text-2xl text-gray-100 mb-10 leading-relaxed max-w-2xl drop-shadow-md">
