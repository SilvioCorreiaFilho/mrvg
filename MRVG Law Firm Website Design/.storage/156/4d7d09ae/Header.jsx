  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-500 ${animationClass} ${isScrolled ? 'bg-gray-900/70 backdrop-blur-xl shadow-lg py-4' : 'bg-transparent py-8'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        {/* Desktop Navigation */}
        <nav className={`hidden md:flex items-center ${isIconsOnly ? 'space-x-8' : 'space-x-12'} uppercase text-xs tracking-widest transition-all duration-500`}>
          <a href="#sobre" className={`transition-all duration-300 ease-in-out font-medium relative group flex items-center ${isIconsOnly ? 'justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-white/20' : 'gap-2'} ${isScrolled ? 'text-gray-800 hover:text-gray-900' : 'text-white hover:text-white'}`} title="Sobre">
          ...
          <a href="#atuacao" className={`transition-all duration-300 ease-in-out font-medium relative group flex items-center ${isIconsOnly ? 'justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-white/20' : 'gap-2'} ${isScrolled ? 'text-gray-800 hover:text-gray-900' : 'text-white hover:text-white'}`} title="Áreas de Atuação">
          ...
          <a href="#equipe" className={`transition-all duration-300 ease-in-out font-medium relative group flex items-center ${isIconsOnly ? 'justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-white/20' : 'gap-2'} ${isScrolled ? 'text-gray-800 hover:text-gray-900' : 'text-white hover:text-white'}`} title="Equipe">
          ...
          <a href="#blog" className={`transition-all duration-300 ease-in-out font-medium relative group flex items-center ${isIconsOnly ? 'justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-white/20' : 'gap-2'} ${isScrolled ? 'text-gray-800 hover:text-gray-900' : 'text-white hover:text-white'}`} title="Blog">
          ...
          <a href="#contato" className={`transition-all duration-300 ease-in-out font-medium flex items-center ${isIconsOnly ? 'justify-center w-10 h-10 border border-opacity-70 rounded-full' : 'border border-opacity-70 px-7 py-2 gap-2'} ${isScrolled ? 'border-gray-800 text-gray-800 hover:bg-gray-800 hover:bg-opacity-10' : 'border-white text-white hover:bg-white hover:bg-opacity-10'}`} title="Contato">
