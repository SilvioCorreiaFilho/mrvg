    ...
    <section id="commemorative" className="py-16 px-4 md:px-10 lg:px-16 bg-[#e7e7e7]">  
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative flex justify-center mb-16 mt-4">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 overflow-hidden">
              <img 
                src="/assets/images/new_anniversary_art.jpeg" 
                alt="MRVG 15 Anos" 
                className="h-auto w-full max-w-lg object-contain transition-all duration-500" 
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-8 md:p-10 mb-16 border border-gray-200 relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-16 h-16 border-t-2 border-l-2 border-[#B0843B]/30 rounded-tl-2xl"></div>
          <div className="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-[#B0843B]/30 rounded-br-2xl"></div>
          
          <h3 className="text-2xl font-semibold text-gray-800 mb-8 text-center relative">
            <span className="relative inline-block">
              Nossa Evolução
              <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-0.5 bg-gradient-to-r from-transparent via-[#B0843B] to-transparent"></span>
            </span>
          </h3>
          
          <div className="relative h-[450px] z-10 mt-10">
