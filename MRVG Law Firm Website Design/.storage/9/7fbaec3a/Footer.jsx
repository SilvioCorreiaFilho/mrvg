        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#atuacao" className="text-gray-400 hover:text-white transition-colors">Contratos</a>
              </li>
              <li>
                <a href="#atuacao" className="text-gray-400 hover:text-white transition-colors">Direito Imobiliário</a>
              </li>
              <li>
                <a href="#atuacao" className="text-gray-400 hover:text-white transition-colors">Direito de Família</a>
              </li>
            </ul>
          </div>
